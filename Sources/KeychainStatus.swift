...
public enum KeychainStatus: OSStatus, Error {
    ...
    case coreFoundationUnknown              = -4960
    case missingEntitlement                 = -34018
    @available(iOS 14.0, *)
    case restrictedAPI                      = -34020
    ...
    case certificatePolicyNotAllowed        = -67899
    case certificateNameNotAllowed          = -67900
    case certificateValidityPeriodTooLong   = -67901
    @available(iOS 14.0, *)
    case certificateIsCA                    = -67902
    @available(iOS 15.0, *)
    case certificateDuplicateExtension      = -67903
    
    case unspecifiedError = -99999
